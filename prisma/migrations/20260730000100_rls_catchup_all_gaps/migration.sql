-- RLS catch-up — closes the drift gap documented in docs/ai/ARCHITECTURE_REVIEW.md § F5.
--
...
-- idempotent loop — DROP POLICY IF EXISTS + CREATE POLICY — restricted to the 364 tables
